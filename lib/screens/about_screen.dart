        ...
        child: Column(
          ...
          children: [
            ...
            _buildContentCard([
              ...
              _buildBullet('Greeting & Header', 'Displays a personalized greeting alongside your active status and Hydration Rank badge.'),
              _buildBullet('Streak Badge & Risk Warning', 'Active streak counter with automatic risk warnings triggered after 4:00 PM if progress is under 40%.'),
              ...
              _buildSubHeading('3.2 History Screen (HistoryScreen)'),
              _buildParagraph('Provides full transparency into past hydration consistency and records:'),
              _buildBullet('Overview Metrics', 'Lifetime Volume, Completed vs. Incomplete days, 30-day Success Rate, and Anti-Wrinkle Shield status.'),
              _buildBullet('Calendar Date Picker', 'Navigate to any past date to inspect historical entries.'),
              _buildBullet('Daily Activity Heatmap', 'Color-coded consistency grid across past months.'),
              _buildBullet('Sip Timeline', 'Timestamped log of every drink logged with individual delete actions.'),
              const Divider(color: Colors.white12, height: 24),

              _buildSubHeading('3.3 Insights Screen (InsightsScreen)'),
              _buildParagraph('Combines biometric goal calculation, weekly trends, and meal reminders:'),
              _buildBullet('Goal Calculator', 'Calculates exact intake needs based on weight (kg), activity level, and climate.'),
              _buildBullet('Rank Roadmap', 'Real-time progress bar toward the next hydration rank tier.'),
              _buildBullet('7-Day Hydration Analytics', 'Spacious bar chart comparing daily intake against the 100% target baseline with color-coded consistency indicators.'),
              _buildBullet('AI Trend Analysis', 'Rule-based evaluation summarizing peak days, lowest dips, and consistency.'),
              _buildBullet('Meal Times Schedule', 'Breakfast, Lunch, and Dinner schedule for 30-minute digestive reminders.'),
              const Divider(color: Colors.white12, height: 24),

              _buildSubHeading('3.4 Settings Screen (SettingsScreen)'),
              _buildParagraph('Complete configuration for notifications, alarms, and local storage:'),
