...
class BootReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        try {
            ...
            // Flutter stores StringSet values with the "flutter." prefix
            val allTimes     = prefs.getStringSet("flutter.reminder_times", null) ?: return
            ...
            for (timeStr in activeTimes) {
                ...
                scheduleAlarm(context, alarmManager, notifId, nextMillis)
                notifId++
            }
        } catch (e: Exception) {
